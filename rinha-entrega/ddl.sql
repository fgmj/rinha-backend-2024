--DDL
create UNLOGGED table cliente (id bigserial not null, 
limite bigint, 
saldo bigint, 
primary key (id));
create UNLOGGED table transacao (tipo char(1) not null, valor numeric(10,0) not null, cliente_id bigint not null, data_lancamento timestamp(6), id bigserial not null, descricao varchar(10) not null, primary key (id));
